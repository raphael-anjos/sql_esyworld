SELECT DISTINCT
       ...
       revenda.cod_cliente AS 'Codigo (Cliente)',
		 ...
		 revenda.nome_vendedor AS 'Nome Vendedor',
...
WHERE revenda.razao_social IS NOT NULL AND revenda.cod_cliente = qualificacao.codCliente AND qualificacao.descricao LIKE 'KASP%_%' AND revenda.contact_rank <= 3
