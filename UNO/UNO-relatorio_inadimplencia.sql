...
WHERE dt_vencimento BETWEEN '2020-01-01' AND DATE_SUB(CURDATE(), INTERVAL 1 DAY)
		...
		AND receber.cod_forma_pagto <> 33 AND receber.cod_forma_pagto <> 8 AND receber.cod_forma_pagto <> 31 AND receber.cod_forma_pagto <> 10 
	   AND nf.cod_colaborador <> 5794 AND nf.cod_colaborador <> 7580
